...
subtitle: |
  ...
  | Submodel with Random, Fixed Intercept, without Student VR Band, School Gender
editor_options:
...
init1 <- list(beta0 = 0, beta = c(0, 0, 0, 0), alpha00 = 0, alpha0 = 0, phi0 = 1, psi = 1)
init2 <- list(beta0 = 0, beta = c(1, -1, -1, -1), alpha00 = 0, alpha0 = 1, phi0 = 0.5, psi = 0.5)
...
model <- bugs(data, inits, parameters, 
              model.file = "submodel_with_intercept_without_student_VR_school_gender.txt", 
...
Variable <- c("y_Int", colnames(X), "u_Int", colnames(d)[6], "var_u0", "var_y")
