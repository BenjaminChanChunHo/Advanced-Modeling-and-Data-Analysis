...
subtitle: |
  ...
  | Submodel with Random Intercept and without School Effect Predictor
editor_options:
...
init1 <- list(beta = c(0, 0, 0, 0, 0, 0), phi0 = 1, psi = 1)
init2 <- list(beta = c(1, -1, 1, -1, -1, -1), phi0 = 0.5, psi = 0.5)
...
model <- bugs(data, inits, parameters, 
              model.file = "submodel_with_random_intercept_without_school_effect_predictor.txt", 
