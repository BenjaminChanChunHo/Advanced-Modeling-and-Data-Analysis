...
subtitle: |
  ...
  | Submodel with Random and Fixed Intercept, without Student Gender and VR Band
editor_options:
...
# LR.Test.Score, Student.Band.Mid, Student.Band.Top
X <- d[, c(4, 11:12)]
...
init1 <- list(beta0 = 0, beta = c(0, 0, 0), alpha00 = 0, alpha0 = c(0, 0, 0), phi0 = 1, psi = 1)
init2 <- list(beta0 = 0, beta = c(1, -1, -1), alpha00 = 0, alpha0 = c(1, -1, 1), phi0 = 0.5, psi = 0.5)
...
model <- bugs(data, inits, parameters, 
              model.file = "submodel_with_intercept_without_student_gender_and_VR_band.txt", 
