...
subtitle: |
  ...
  | Submodel with Random, Fixed Intercept, without Student VR, School Intake Score
editor_options:
...
init1 <- list(beta0 = 0, beta = c(0, 0, 0, 0), alpha00 = 0, alpha0 = c(0, 0), phi0 = 1, psi = 1)
init2 <- list(beta0 = 0, beta = c(1, -1, -1, -1), alpha00 = 0, alpha0 = c(-1, 1), phi0 = 0.5, psi = 0.5)
...
model <- bugs(data, inits, parameters, 
              model.file = "submodel_with_intercept_without_student_VR_school_intake.txt",
