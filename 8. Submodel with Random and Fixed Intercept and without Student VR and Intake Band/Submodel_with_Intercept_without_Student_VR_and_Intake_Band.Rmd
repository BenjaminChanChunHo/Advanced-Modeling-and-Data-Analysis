...
subtitle: |
  ...
  | Submodel with Random and Fixed Intercept, without Student VR and Intake Band
editor_options:
...
model <- bugs(data, inits, parameters, 
              model.file = "submodel_with_intercept_without_student_VR_and_intake_band.txt", 
